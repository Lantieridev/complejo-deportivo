...
namespace ComplejoDeportivo.Infrastructure.Repositories
{
    public class ReservaRepository : IReservaRepository
    {
        ...
        public Tarifa ObtenerTarifaVigenteEnMemoria(IEnumerable<Tarifa> tarifas, int canchaId, DateOnly fecha, TimeOnly hora)
        {
        ...
        {
            return await _contexto.Reservas.FirstOrDefaultAsync(r => r.ReservaId == reservaId);
        }
